      ...
      <div className="row row-cols-1 row-cols-md-1 row-cols-lg-2">
        <div className="col col-left pe-5 pt-5">
          ...
          <div className="section">
            ...
            <div class="row">
              ...
              <div className="col">
                <select
                  style={{ width: "100%", height: "", marginBottom: "40px" }}
        ...
        <div className="col col-right ps-5 pt-5 rounded shadow">
          <table className="table">
            <tbody>
              {cartStore.cart && cartStore.cart.length > 0 ? (
                  ...
                  return (
                    <tr key={index}>
                      <td className="cart-product-img">
                        <img
                          src={item._id.description.imageList[0]}
                          alt=""
                          className="border"
                        ></img>
                      </td>
                ...
                <tr>
                  <td className="text-center">Không có sp</td>
                </tr>
              )}
            </tbody>
          </table>
          <div class="row py-3 border-bottom">
            ...
            <div className="col-3">
              <button className="btn btn-secondary">Sử dụng</button>
            </div>
          </div>
          <div class="row py-3 border-bottom">
