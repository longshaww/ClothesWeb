...
export default function DetailBill() {
    ...
    useEffect(() => {
        const getData = async () => {
            const endpoint = `${process.env.REACT_APP_API_URL}bill/detailBill/${id}`;
                                    ...
                                    {data.listProduct.map((el) => (
                                        <>
                                            ...
                                            "
                                                    ...
                                                    >
                                                        <img
                                                            src={el._id.description.imageList[0]}
                                                            className="w-100"
                                                            height="100px"
                                                ...
                                                <div className="col-md-5 mb-4 mb-md-0">
                                                    <p className="fw-bold">{el._id.nameProduct}</p>
                                                    <p className="mb-1">
                                                        <span className="text-muted me-2">Size:</span>
                                                        <span>{el.size}</span>
                                                    </p>
                                                    <p>
                                                        <span className="text-muted me-2">Giá Tiền:</span>
                                                        <span>{el._id.price.toLocaleString()},000 VND</span>
                                                    </p>
                                                </div>
                                                <div className="col-md-2 mb-4 mb-md-0">
                                                ...
                                                <div className="col-md-3 mb-4 mb-md-0">
                                                    ...
                                                    <span>{el.sum.toLocaleString()},000 VND</span>
                                                    </p>
                                                </div>
                                            </div>
                                            <hr></hr>
                                        ...
                                        <div className="col-xl-3">
                                            <ul className="list-unstyled">
                                                <li className="text-muted ms-3">
                                                    ...
                                                    <span>{data.total.toLocaleString()},000 VND</span>
                                                </li>
                                                <li className="text-muted ms-3 mt-2">
                                                    <span className="text-black">Phí Ship :</span>
                                                    <span style={{marginLeft:"10px"}}>35,000 VND</span>
                                                </li>
                                            </ul>
                                            <hr></hr>
                                            <p className="text-black float-start" style={{marginLeft:"15px"}}>
                                                <span className="text-black me-3">Tổng Tiền</span>
                                                <span style={{ fontSize: "25px" }}>{(data.total+35).toLocaleString()},000 VND</span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
